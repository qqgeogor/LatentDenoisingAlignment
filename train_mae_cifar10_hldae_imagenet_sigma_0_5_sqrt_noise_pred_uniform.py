...
from utils_ibot import UniformSVDPatchPCANoise
...
def visualize_reconstruction(model, images, mask_ratio=0.75, save_path='reconstructions',noise_scale=1.,pca_noiser=None):
    ...
    if pca_noiser is None:
        pca_noiser = UniformSVDPatchPCANoise(patch_size=model.patch_size, noise_scale=noise_scale)
...
def train_mae():
    ...
    pca_noiser = UniformSVDPatchPCANoise(patch_size=args.noiser_patch_size, noise_scale=args.noise_scale)
