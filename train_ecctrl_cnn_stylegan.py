...
def train_ebm_gan(args):
    ...
    discriminator = Encoder(img_channels=3, latent_dim=args.embed_dim).to(device)    

    teacher_discriminator = Encoder(img_channels=3, latent_dim=args.embed_dim).to(device)    
