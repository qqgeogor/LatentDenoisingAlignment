...
def visualize_reconstruction(model, images, mask_ratio=0.75, save_path='reconstructions'):
    ...
    with torch.no_grad():
        ...
        pred2,_ = model.sampler.sample(model,images,mask_ratio=mask_ratio,latent=latent,mask=mask,ids_restore=ids_restore)
        ...
        masked_images = denormalize_image(masked_images)
